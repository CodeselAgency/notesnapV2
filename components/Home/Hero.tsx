    ...
    <motion.section className="mt-16 sm:mt-20 md:mt-24 px-4 sm:px-6 text-center flex items-center justify-center relative min-h-screen sm:min-h-[85vh] md:min-h-[75vh] lg:min-h-[65vh] bg-white flex-col overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="absolute left-[5%] top-[20%] z-0 -rotate-24"
        >
        ...
        <motion.div
          ...
          className="absolute right-[5%] top-[15%] z-0 rotate-24"
        >
        ...
        <motion.div
          ...
          className="absolute left-[8%] bottom-[15%] z-0 -rotate-24"
        >
        ...
        <motion.div
          ...
          className="absolute right-[8%] bottom-[20%] z-0 rotate-24"
        >
