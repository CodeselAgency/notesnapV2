...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] flex-col items-center justify-center overflow-hidden bg-black w-full rounded-t-[24px] z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <motion.div
          ...
          //   backgroundImage: `conic-gradient(var(--conic-position), var(--tw-gradient-stops))`,
          // }}
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-black text-white [--conic-position:from_290deg_at_center_top]"
        >
      ...
      <div className="relative z-50 flex flex-col items-center justify-center px-5 text-center mt-8 mb-8">
        {children}
      </div>
    </div>
  );
