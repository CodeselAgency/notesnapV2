...
import { PricingButton } from "@/components/PricingButton"; // We'll create this component
...
export default async function PricingPage() {
  ...
  const freePlan = {
    ...
    requiresAuth: false, // Free plan doesn't require auth
  };
  ...
  const plans = [
    ...
    ...products.result.items.map((product) => {
      ...
      return {
        ...
        requiresAuth: true, // Paid plans require authentication
      };
    }),
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-16 px-4">
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-12">
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                {/* CTA Button - Now using client component */}
                <PricingButton
                  plan={plan}
        ...
        <div className="text-center mt-16">
          ...
          <button className="bg-white text-gray-900 px-8 py-3 rounded-xl font-semibold border-2 border-gray-200 hover:border-gray-300 transition-all duration-200 shadow-md hover:shadow-lg">
            Contact Sales
          </button>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                ...
                upgrade or purchase additional credits as needed.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">
              ...
              <p className="text-gray-600 text-sm">
                Our Free plan lets you try the service with no commitment. No
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Plans are billed automatically. Weekly plans renew every 7 days,
                monthly plans every 30 days, and yearly plans every 365 days.
              </p>
            </div>
          </div>
        </div>
