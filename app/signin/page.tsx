          ...
          <div className="inline-block">
            <div className="relative">
              <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 via-purple-500 to-violet-600 rounded-2xl shadow-xl flex items-center justify-center transform -rotate-6 group transition-all duration-300 hover:rotate-0">
                <span className="text-4xl font-bold text-white group-hover:scale-110 transition-transform duration-300">N</span>
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="text-center mb-10">
              ...
              >
                Join <span className="font-semibold text-indigo-600">10,000+</span> students studying smarter
              </motion.p>
            </div>
            ...
            >
              ...
              <a href="/terms" className="font-medium text-indigo-600 hover:text-indigo-700 transition-colors">
                Terms of Service
              </a>{" "}
              and{" "}
              <a href="/privacy" className="font-medium text-indigo-600 hover:text-indigo-700 transition-colors">
                Privacy Policy
              </a>
            </motion.p>
          </div>
